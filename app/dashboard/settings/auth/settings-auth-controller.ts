...
/**
 * Settings authentication controller
 * Handles authentication logic for settings pages
 */
export class SettingsAuthController {
  /**
   ...
   */
  static checkAuthentication(isLoaded: boolean, isSignedIn: boolean): boolean {
   ...
   */
  static isLoading(isAuthLoaded: boolean, isUserLoading: boolean): boolean {
